...
public class StaffController {
	...
	public String modifyStaffActive(Staff staff) {
		...
		// 직원의 상태 변경
		Integer row = staffService.modifyStaff(staff); //어떤 컬럼값을 수정하던 mapper 메서드는 하나다.(my batis의 장점)
	...
	public String staffList(Model model
		...
		// staffService에서 고객 목록과 페이징 정보를 가져옴
		Map<String, Object> resultMap = staffService.getStaffList(currentPage, rowPerPage);
	...
	public String staffOne(HttpSession session, Model model) {
		...
		Integer staffId = ((Staff)(session.getAttribute("loginStaff"))).getStaffId();
		// 직원 상세 정보 조회
